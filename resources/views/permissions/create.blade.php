...
<section class="content">
    ...
    <div class="box box-primary">
        <!-- form start -->
        <form class="form-horizontal" enctype="multipart/form-data" method="POST" id="permissionForm" action="{{ route('permissions.store') }}">
            @csrf
            <div class="box-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" placeholder="Tên quyền" value="{{ old('name') }}">
                        @error('name')
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" name="key" class="form-control @error('key') is-invalid @enderror" id="key" placeholder="Từ khóa" value="{{ old('key') }}">
                        @error('key')
                            <span class="invalid-feedback" role="alert">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <textarea id="path" name="path"  class="form-control" rows="5" placeholder="Đường dẫn http">{{ old('path') }}</textarea>
                    </div>
                </div>
                <div class="form-group">
