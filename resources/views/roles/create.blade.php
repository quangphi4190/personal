...
<section class="content">
    ...
    <div class="box box-primary">
        <!-- form start -->
        <form class="form-horizontal" enctype="multipart/form-data" method="POST" action="{{ route('roles.store') }}">
            @csrf
            <div class="box-body">
                ...
                <div class="form-group">
                    <label for="password" class="col-sm-2 control-label">Các quyền</label>
                    <div class="col-sm-8">
