		...
		<form class="form-horizontal" action="{{ route('banners.store') }}" method="POST">
			...
			<div class="box-body">
				<div class="form-group">
					<label class="col-sm-2 control-label" for="name">Tiêu đề chính <span class="c-red">*</span></label>
					<div class="col-sm-8">
						<input autocomplete="off" name="title" type="text" class="translate-item translate-vi form-control" value="{{ old('title') }}" placeholder="Nhập tiêu đề chính">
					</div>
				</div>
				{{--<div class="form-group">--}}
					{{--<label class="col-sm-2 control-label" for="name">Tiêu đề con <span class="c-red">*</span></label>--}}
					{{--<div class="col-sm-8">--}}
						{{--<input autocomplete="off" name="subTitle" type="text" class="translate-item translate-vi form-control" value="{{ old('subTitle') }}" placeholder="Nhập tiêu đề con">--}}
					{{--</div>--}}
				{{--</div>--}}
				<div class="form-group">
					...
					<div class="col-sm-8">
						<div class="input-group">
							...
							<input readonly class="form-control cursor browseServer" type="text" name="image">
						</div>
						<div class="blah-wrap">
