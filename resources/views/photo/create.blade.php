...
<section class="content">
	...
	<div class="box">
		<form class="form-horizontal" action="{{ route('photo.store') }}" method="POST">
			@csrf
			<div class="box-body">
				<div class="form-group">
					<label class="col-sm-2 control-label" for="name">Tiêu đề <span class="c-red">*</span></label>
					<div class="col-sm-8">
						<input autocomplete="off" name="title" type="text" class="@error('title') is-invalid @enderror form-control" value="{{ old('title') }}" placeholder="Nhập tiêu đề">
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-8">
						<div class="input-group">
							...
							<input readonly class="form-control cursor browseServer @error('image') is-invalid @enderror" type="text" name="image">
						</div>
						<div class="blah-wrap">
				...
				<div class="form-group">
					<div class="col-sm-offset-2 col-sm-8">
						<div class="checkbox">
							<label>
								<input type="checkbox" name="feature"> Nổi bật
							</label>
						</div>
					</div>
				</div>
