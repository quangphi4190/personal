                    ...
                    <form class="form-horizontal" enctype="multipart/form-data" method="POST" action="{{ route('users.update', $user->id) }}">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="inputName1" name="name" placeholder="Họ và tên" value="{{$user->name}}">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="phonenum" name="phone" type="text" class="form-control" placeholder="Điện thoại" value="{{$user->phone}}">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="city" name="city" type="text" class="form-control" placeholder="Thành phố" value="{{$user->city}}">
                                </div>
                            </div>
