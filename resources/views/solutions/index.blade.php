    ...
    <section class="content">
        ...
        <div class="box box-primary">
            <div class="box-header">
                <a href="{{ route('solutions.create') }}" class="btn btn-primary" title="Thêm mới"><i
                            class="fa fa-plus" aria-hidden="true"></i> {{$create}}</a>
            </div>
            <div class="box-body responsive-table">
                <table width="100%" id="solutions-list" class="table table-bordered table-hover">
                    <thead>
                    <tr>
                        <th>ID</th>
                        <th>Tiêu đề</th>
