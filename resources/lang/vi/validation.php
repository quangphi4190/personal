...
return [
    ...
    */
    'custom' => [
        ...
        'category_id' => [
            'required' => 'Trường danh mục không được bỏ trống.'
        ],
        'key' => [
            'required' => 'Trường từ khóa không được bỏ trống.'
        ],
        'region_id' => [
            'required' => 'Trường khu vực không được bỏ trống.'
        ],
        'province_id' => [
            'required' => 'Trường tỉnh/TP không được bỏ trống.'
        ],
        'image' => [
            'required' => 'Trường hình ảnh không được bỏ trống.'
        ],
        'branch_id' => [
            'required' => 'Trường ngành nghề/Công việc không được bỏ trống.'
        ]
    ],
    /*
    |--------------------------------------------------------------------------
