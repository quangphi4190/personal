...
abstract class ParticipantOptions {
     ...
     *                              participant is in contacts with
...
class CreateParticipantOptions extends Options {
    ...
    /**
     * The address of the Twilio phone number, WhatsApp number, or Messenger Page ID that the participant is in contacts with. This field, together with user_address, is only null when the participant is interacting from a Chat endpoint (see the 'identity' field).
     *
     * @param string $twilioAddress The address of the Twilio phone number that the
     *                              participant is in contacts with
     * @return $this Fluent Builder
