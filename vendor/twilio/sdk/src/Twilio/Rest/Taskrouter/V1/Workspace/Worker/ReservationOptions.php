...
abstract class ReservationOptions {
     ...
     *                            instruction
     * @param string $dequeueTo The contacts URI of the worker when executing a
     *                          Dequeue instruction
     ...
     *                         instruction
     * @param string $callTo The contacts URI of the worker when executing a Call
     *                       instruction
...
class UpdateReservationOptions extends Options {
    ...
    /**
     * The contacts URI of the worker when executing a Dequeue instruction. Can be the URI of the Twilio Client, the SIP URI for Programmable SIP, or the [E.164](https://www.twilio.com/docs/glossary/what-e164) formatted phone number, depending on the destination.
     *
     * @param string $dequeueTo The contacts URI of the worker when executing a
     *                          Dequeue instruction
     * @return $this Fluent Builder
    ...
    /**
     * The contacts URI of the worker when executing a Call instruction. Can be the URI of the Twilio Client, the SIP URI for Programmable SIP, or the [E.164](https://www.twilio.com/docs/glossary/what-e164) formatted phone number, depending on the destination.
     *
     * @param string $callTo The contacts URI of the worker when executing a Call
     *                       instruction
     * @return $this Fluent Builder
